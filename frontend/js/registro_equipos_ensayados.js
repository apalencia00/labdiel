...
$(document).ready(function(){
  ...
  var win = window.open('http://35.161.39.86:8080/LabDielectrico/webresources/inspeccion/imprimirEnsayoMantas?cotic='+cotic, '_blank');
  win.focus();
  ...
  var win = window.open('http://35.161.39.86:8080/LabDielectrico/webresources/inspeccion/imprimirEnsayoCalzado?cotic='+cotic, '_blank');
  win.focus();
  ...
  var win = window.open('http://35.161.39.86:8080/LabDielectrico/webresources/inspeccion/imprimirEnsayoPuestaTierra?cotic='+cotic, '_blank');
  win.focus();
