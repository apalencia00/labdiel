...
$(document).ready(function(){
  ...
  var win = window.open('http://35.161.39.86:8080/LabDielectrico/webresources/inspeccion/imprimirEnsayoGuante?cotic=COTIC-'+cotic, '_blank');
  win.focus();
  ...
  var win = window.open('http://35.161.39.86:8080/LabDielectrico/webresources/inspeccion/imprimirEnsayoMantas?cotic=COTIC-'+cotic, '_blank');
  win.focus();
  ...
  var win = window.open('http://35.161.39.86:8080/LabDielectrico/webresources/inspeccion/imprimirEnsayoCalzado?cotic=COTIC-'+cotic, '_blank');
  win.focus();
  ...
  var win = window.open('http://35.161.39.86:8080/LabDielectrico/webresources/inspeccion/imprimirEnsayoPuestaTierra?cotic=COTIC-'+cotic, '_blank');
  win.focus();
...
function imprimir_report(number){
 ...
 var win = window.open('http://35.161.39.86:8080/LabDielectrico/webresources/inspeccion/imprimirEnsayoGuante?serial='+number, '_blank');
 win.focus();
