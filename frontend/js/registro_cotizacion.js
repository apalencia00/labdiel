...
$("#genped").click(function(){
  ...
  var win = window.open('http://ec2-35-161-39-86.us-west-2.compute.amazonaws.com:8080/LabDielectrico/webresources/cotizacion/imprimirCotizacion?ncotic='+$("#nocotic").val()+"&tiempo="+men, '_blank');
  win.focus();
...
var win = window.open('http://ec2-35-161-39-86.us-west-2.compute.amazonaws.com:8080/LabDielectrico/webresources/recibo_inout/imprimirCotizacion?ncotic='+$("#nocotic").val()+"id_cliente="+$("#listCliente").val(), '_blank');
win.focus();
