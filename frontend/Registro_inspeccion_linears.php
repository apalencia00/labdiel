...
if( $_SESSION['admon_mod'] != 0 || $_SESSION['admon_mod'] != "" || $_SESSION['admon_mod'] != null  )  {
  ...
  <head>
    ...
    <script type="text/javascript" src="js/registro_linears.js" ></script>
      ...
      <form id="form" class="form-inline" role="form">
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2 col-xs-5">
             ...
             <select id="listClientelinears" class="form-control">
        ...
        <table id="dataTable" class="table table-striped">
          ...
          <tbody >
            <tr>
              <td colspan="5">
                <div id="act_table_coticlinears" style="width: 100%; height: 200px; overflow-y: scroll;" > </div>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <fieldset  >    
          ...
          <table  class="table table-striped">
            ...
            <tbody>
              <tr>
                <td colspan="5">
                  <div id="act_table_seriallinears" style="width: 100%; height: 200px; overflow-y: scroll;" > </div></td>
                </tr>
              </tbody>
            </table>
    ...
    <div class="row">
        <div class="span12">
            <ul class="nav nav-tabs" id="myTabs">
              ...
              <li><a href="#dpa" data-toggle="tab">2.Registro De Mediciones Durante el Ensayo a Liners</a></li>
             
            </ul>
            
            <div class="tab-content" >
              <div class="tab-pane active" id="home" data-src="">
                  <iframe id="frameid1" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen class="embed-responsive-item" width="100%" height="400px" src="PPEnsayoLinears.php"></iframe>           
                </div>
              <div class="tab-pane" id="dpa" data-src="">
                  <iframe frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen class="embed-responsive-item" width="100%" height="500px"  src="PSEnsayoLinears.php"></iframe>
                </div>
