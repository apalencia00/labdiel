...
curl_setopt($curl, CURLOPT_URL, "http://173.199.148.4:8080/LabDielectrico/webresources/cliente/getClienteById?id_cliente=".$id);
...
curl_setopt($curl, CURLOPT_URL, "http://173.199.148.4:8080/LabDielectrico/webresources/ensayo/ensayosCliente?".http_build_query($params));
...
function insertarDetalleEquipoCotizacion(){
    ...
    curl_setopt($curl, CURLOPT_URL, "http://173.199.148.4:8080/LabDielectrico/webresources/cotizacion/regdetallecotizacion?id_cliente");
...
curl_setopt($curl, CURLOPT_URL, "http://173.199.148.4:8080/LabDielectrico/webresources/cotizacion/getCurrentcotic?id_usuario=".$usu);
...
curl_setopt($curl, CURLOPT_URL, "http://173.199.148.4:8080/LabDielectrico/webresources/cotizacion/regdetallecotizacion?".http_build_query($params));
