...
if( $_SESSION['admon_mod'] != 0 || $_SESSION['admon_mod'] != "" || $_SESSION['admon_mod'] != null  )  {
  ...
  if(isset($_GET['method'])){
    ...
    switch ($method) {
      ...
      $param3 = array("serial" => $_GET['serial'], "cotizacion" => $_GET['cotizacion'],"tension" => $_GET['tension'], "fuga" => $_GET['fuga'], "temperatura" => $_GET['temperatura'], "humedad" => $_GET['humedad'], "tiempo" => $_GET['tiempo'], "obs_final" => $_GET['observaciones']);
