 ...
 *
 * use UCSDMath\Functions\EasterEggFunctions;
 *
 * Method list:
 *
 ...
 *
 *    use UCSDMath\Functions\EasterEggFunctions;
 *    use UCSDMath\Functions\EasterEggFunctionsInterface;
 *
 *    /**
 *     * The Sftp class with trait methods and the interfaces added.
 *     * /
 *    class Sftp extends AbstractSftpAdapter implements SftpInterface, EasterEggFunctionsInterface
 *    {
 *        /**
 *         * Properties.
 *         * /
...
trait EasterEggFunctions
{
     ...
     *
     * @param integer  $number  A specific Lefler Law to return
     *
     * @return string  A random law will be returned if out-of-range, non-existent, or none provided
     *
     * @api
     */
    public function getLeflersLaw($number = null)
    {
        return in_array($number, array_keys($this->theLaws)) ? $this->theLaws[$number] : $this->theLaws[array_rand($this->theLaws, 1)];
    }
}
